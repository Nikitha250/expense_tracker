...
import 'package:track_your_expenses/screens/add_expense/blocs/get_categories_bloc/get_categories_bloc.dart';
import 'package:track_your_expenses/screens/add_expense/views/category_creation.dart';
    ...
    return BlocListener<CreateExpenseBloc, CreateExpenseState>(
      ...
      child: GestureDetector(
        onTap: () => FocusScope.of(context)
            .unfocus(), //enables to unfocus when the user clicks outside the text field.
        child: Scaffold(
            backgroundColor: Theme.of(context).colorScheme.surface,
            appBar: AppBar(
              //allows use to go back and forth the home and add expenses pages.
              backgroundColor: Theme.of(context).colorScheme.surface,
            ),
